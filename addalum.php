...
<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
          ...
          <div class="container-fluid">
            ...
            <a class="navbar-brand" href="adminhome.php">TPC</a>
...
<label for="rollno" class="form-label">
    ...
    <input type = "text" class="form-control" value = "" name = "pyear">
    </div>
    <div class="col-12">
		<button type="submit"  name="submit" class="btn btn-primary"  >Add Alumnus</button>
        </div>
</form>
</div>
<br>
...
if(isset($_POST["submit"])){
    ...
    $sql = "insert into alumnus values('$rollno', '$ccode','$ctc', '$area','$position', '$tenure','$pyear')";
