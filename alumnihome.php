              ...
              <div class="col">
                <div class="card" style="width: 20vw;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"></p>
                      <a href="alumni_dashboard.php" class="btn btn-dark">Dashboard</a>
                    </div>
                  </div>
              </div>
              <div class="col">
              ...
              <div class="col">
                <div class="card" style="width: 20vw;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"></p>
                      <a href="alumni_alumni.php" class="btn btn-dark">Alumni</a>
                    </div>
                  </div>
              </div>
              ...
              <div class="col">
                <div class="card" style="width: 20vw;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"></p>
                      <a href="alumni_placement.php" class="btn btn-dark">Placements</a>
                    </div>
                  </div>
              </div>
              ...
              <div class="col">
                <div class="card" style="width: 20vw;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"></p>
                      <a href="alumni_stats.php" class="btn btn-dark">Statistics</a>
                    </div>
                  </div>
              </div>
